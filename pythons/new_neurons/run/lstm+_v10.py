...
class LSTMCell_modified(tf.keras.layers.LSTMCell):
    ...
    def _compute_carry_and_output(self, x, h_tm1, c_tm1):
        ...
        c = f * c_tm1 + i * self.activation(self.activation(self.activation(x_c + tf.keras.backend.dot(
    ...
    def _compute_carry_and_output_fused(self, z, c_tm1):
        ...
        c = (f * c_tm1 + i * self.activation(self.activation(self.activation(z2)))) * c_tm1 # making the quaratic function
